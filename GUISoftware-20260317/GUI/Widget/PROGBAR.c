...
static void _Paint(PROGBAR_Handle hObj)
{
    ...
    //GUI__ReduceRect(&rInside, &rClient, pObj->Widget.pEffect->EffectSize);//zkq 20161125
    GUI__ReduceRect(&rInside, &rClient,0);
                                ...
                                int WinFlags, int ExFlags, int Id)
{
    ...
    if (hObj)
    {
        ...
        WIDGET_SetEffect(hObj, &WIDGET_Effect_3D); /* Standard effect for progbar: None */
        INIT_ID(pObj);
...
*       PROGBAR_SetTextFlag
*/
void PROGBAR_SetTextFlag(PROGBAR_Handle hObj, unsigned char TextFlag)
{
    PROGBAR_Obj* pObj;
    if (hObj)
    {
