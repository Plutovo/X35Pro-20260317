...
*       _DrawRoundRect
*/
static void _DrawRoundRect(int x0, int y0, int x1, int y1,int r)
{
    GL_DrawArc(x0+r,y0+r,r,r,90,180);
    GL_DrawArc(x1-r,y0+r,r,r,0,90);
    GL_DrawArc(x0+r,y1-r,r,r,180,270);
    GL_DrawArc(x1-r,y1-r,r,r,270,360);
    LCD_DrawHLine(x0+r, y0, x1-r);
    LCD_DrawHLine(x0+r, y1, x1-r);
    LCD_DrawVLine(x0, y0+r, y1 - r);
    LCD_DrawVLine(x1, y0 + r, y1 - r);
}
/***************************************************************************************************
*
*       GUI_DrawRoundRect
...
*       GUI_DrawRect
*/
void GUI_DrawRoundRect(int x0, int y0, int x1, int y1,int radius)
{
#if (GUI_WINSUPPORT)
    int Off;
    GUI_RECT r;
    ...
    {
#endif
        _DrawRoundRect(x0, y0, x1, y1,radius);
#if (GUI_WINSUPPORT)
    }
    WM_ITERATE_END();
#endif
