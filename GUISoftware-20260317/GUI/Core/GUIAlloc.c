...
#define GUI_MAXBLOCKS (2 + GUI_ALLOC_SIZE / 64)
#endif
#if defined ( __ICCARM__ )
#ifndef GUI_ALLOC_LOCATION
#define GUI_ALLOC_LOCATION  POOL_HEAP	//gyf modify,使用SDRAM
#endif
#ifndef GUI_MEM_ALLOC          /* Allows us in some systems to place the GUI memory */
#define GUI_MEM_ALLOC  __no_init static    //gyf modify,使用SDRAM  /* in a different memory space ... eg "__far"        */
#endif
#ifndef GUI_BLOCK_LOCATION
#define GUI_BLOCK_LOCATION  POOL_BLOCK	//gyf modify,使用SDRAM
#endif
#else
#ifndef GUI_ALLOC_LOCATION
...
#define GUI_HANDLE U16
#else
#define GUI_HANDLE U8
#endif
/*********************************************************************
*
*       Types
...
typedef struct
{
	...
	GUI_HANDLE Next;         /* next handle in linked list     */
	GUI_HANDLE Prev;
} tBlock;
/*********************************************************************
*
...
static tBlock aBlock[GUI_MAXBLOCKS] GUI_BLOCK_LOCATION;
struct
{
