...
#define GUI_TOUCH_AD_BOTTOM 915
#endif
...
//touch cali 20150519
unsigned short GUI_TOUCH_CalLeft = 0;
unsigned short GUI_TOUCH_CalRight = 0;
unsigned short GUI_TOUCH_CalTop = 0;
unsigned short GUI_TOUCH_CalBottom = 0;
/***************************************************************************************************
*
*       Types
*
...
{
    xyMinMax[0].Min = GUI_TOUCH_CalLeft;
    xyMinMax[0].Max = GUI_TOUCH_CalRight;
    xyMinMax[1].Min = GUI_TOUCH_CalTop; 
    xyMinMax[1].Max = GUI_TOUCH_CalBottom;
    if(0)
    {
...
/*******************************************************************************************************/
void GUI_TOUCH_Convert(int x,int y,unsigned char state)
{
