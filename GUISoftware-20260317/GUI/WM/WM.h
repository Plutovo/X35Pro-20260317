...
#define WM_NOTIFICATION_USER_MBCLICKED     17           ///多唯属性页的单击命令
#define WM_NOTIFICATION_USER_CNBCLICKED    18           ///ChangeNumButtonCtrl控件回车发送的消息
#define CENTER_DATA_CHANGED 1
#define BOTTOM_DATA_CHANGED 2
#define TOP_R_TEXT_CHANGED  3 //  20130412
#define WM_USER_VALUE_CHANGED1	  WM_NOTIFICATION_USER+5
#define WM_USER_VALUE_CHANGED2	  WM_NOTIFICATION_USER+6
#define WM_USER_VALUE_CHANGED3    WM_NOTIFICATION_USER+7
#define WM_USER_VALUE_CHANGED4    WM_NOTIFICATION_USER+8
#define WM_USER_VALUE_CHANGED5    WM_NOTIFICATION_USER+9
#define WM_USER_VALUE_CHANGED6    WM_NOTIFICATION_USER+10
#define WM_USER_VALUE_CHANGED7    WM_NOTIFICATION_USER+11
#define WM_USER_VALUE_CHANGED8    WM_NOTIFICATION_USER+12
#define WM_USER_VALUE_CHANGED9    WM_NOTIFICATION_USER+13
#define WM_USER_VALUE_CHANGED10    WM_NOTIFICATION_USER+14
#define WM_USER_VALUE_CHANGED11    WM_NOTIFICATION_USER+15
#define WM_USER_VALUE_CHANGED12    WM_NOTIFICATION_USER+16
#define WM_USER_VALUE_CHANGED13    WM_NOTIFICATION_USER+17
#define WM_USER_VALUE_CHANGED14    WM_NOTIFICATION_USER+18
#define WM_USER_VALUE_CHANGED15    WM_NOTIFICATION_USER+19
...
#define WM_CF_RESERVED4        (1<<15)
    ...
    */
    ...
    int       WM_GetEnableState       (WM_HWIN hWin);//add 20150911
