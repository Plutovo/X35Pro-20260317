#ifndef _DISPSTRINGLIB_H
#define _DISPSTRINGLIB_H

#include "DispStrs.h"
#include "WIDGET_Patient.h"

#define DlgStr_MAXNUM	44
#define MAC_NUM	81        //tcc add 20220524
...
extern const unsigned int MAC_Ratio[MAC_NUM];//tcc add 20220524
extern const char *cbdialog32string[DlgStr_MAXNUM];

void Initcbdialog32string(Patient_Info_t *tmp_Info, int mode);

extern Disp_Lg_t LanguageType;
