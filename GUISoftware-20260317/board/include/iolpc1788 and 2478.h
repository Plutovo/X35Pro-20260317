...
#define __IOLPC2470_H
	...
	/**********************
	2016.5.16 zy 将IOLPC1788.H和IOLPC2478.H整合，添加宏定义切换
					将LPC1788中两种芯片的共用寄存器名称改为LPC2478寄存器的名称
	***********************/
	
	#ifdef IAR_LPC_2478_STK
		typedef struct{
		__REG32 MAP         : 2;
		__REG32             :30;
		} __memmap_bits;
	...
	#define I21CONCLR I2C1CONCLR
		 ...
		 **
		 ***************************************************************************/
		__IO_REG32_BIT(RTCILR,                   0xE0024000,__READ_WRITE ,__ilr_bits);
		__IO_REG32_BIT(RTCCTC,                   0xE0024004,__READ       ,__ctc_bits);
		__IO_REG32_BIT(RTCCCR,                   0xE0024008,__READ_WRITE ,__rtcccr_bits);
		__IO_REG32_BIT(RTCCIIR,                  0xE002400C,__READ_WRITE ,__ciir_bits);
		__IO_REG32_BIT(RTCAMR,                   0xE0024010,__READ_WRITE ,__amr_bits);
		__IO_REG32_BIT(RTCCTIME0,                0xE0024014,__READ       ,__ctime0_bits);
		__IO_REG32_BIT(RTCCTIME1,                0xE0024018,__READ       ,__ctime1_bits);
		__IO_REG32_BIT(RTCCTIME2,                0xE002401C,__READ       ,__ctime2_bits);
		__IO_REG32_BIT(RTCSEC,                   0xE0024020,__READ_WRITE ,__sec_bits);
		__IO_REG32_BIT(RTCMIN,                   0xE0024024,__READ_WRITE ,__min_bits);
		__IO_REG32_BIT(RTCHOUR,                  0xE0024028,__READ_WRITE ,__hour_bits);
		__IO_REG32_BIT(RTCDOM,                   0xE002402C,__READ_WRITE ,__dom_bits);
		__IO_REG32_BIT(RTCDOW,                   0xE0024030,__READ_WRITE ,__dow_bits);
		__IO_REG32_BIT(RTCDOY,                   0xE0024034,__READ_WRITE ,__doy_bits);
		__IO_REG32_BIT(RTCMONTH,                 0xE0024038,__READ_WRITE ,__month_bits);
		__IO_REG32_BIT(RTCYEAR,                  0xE002403C,__READ_WRITE ,__year_bits);
		__IO_REG32_BIT(RTCCISS,                  0xE0024040,__READ_WRITE ,__ciss_bits);
		__IO_REG32_BIT(RTCALSEC,                 0xE0024060,__READ_WRITE ,__sec_bits);
		__IO_REG32_BIT(RTCALMIN,                 0xE0024064,__READ_WRITE ,__min_bits);
		__IO_REG32_BIT(RTCALHOUR,                0xE0024068,__READ_WRITE ,__hour_bits);
		__IO_REG32_BIT(RTCALDOM,                 0xE002406C,__READ_WRITE ,__dom_bits);
		__IO_REG32_BIT(RTCALDOW,                 0xE0024070,__READ_WRITE ,__dow_bits);
		__IO_REG32_BIT(RTCALDOY,                 0xE0024074,__READ_WRITE ,__doy_bits);
		__IO_REG32_BIT(RTCALMON,                 0xE0024078,__READ_WRITE ,__month_bits);
		__IO_REG32_BIT(RTCALYEAR,                0xE002407C,__READ_WRITE ,__year_bits);
		__IO_REG32_BIT(RTCPREINT,                0xE0024080,__READ_WRITE ,__preint_bits);
		__IO_REG32_BIT(RTCPREFRAC,               0xE0024084,__READ_WRITE ,__prefrac_bits);
	...
	__IO_REG32_BIT(EMCDINAMICCTRL,     0x2009C020,__READ_WRITE ,__emc_dctrl_bits);
	__IO_REG32_BIT(EMCDINAMICRFR,     0x2009C024,__READ_WRITE ,__emc_drfr_bits);
	__IO_REG32_BIT(EMCDINAMICRDCFG,  0x2009C028,__READ_WRITE ,__emc_drdcfg_bits);
	__IO_REG32_BIT(EMCDYNAMICRP,         0x2009C030,__READ_WRITE ,__emc_drp_bits);
	__IO_REG32_BIT(EMCDYNAMICRAS,        0x2009C034,__READ_WRITE ,__emc_dras_bits);
	__IO_REG32_BIT(EMCDYNAMICSREX,       0x2009C038,__READ_WRITE ,__emc_dsrex_bits);
	__IO_REG32_BIT(EMCDYNAMICAPR,        0x2009C03C,__READ_WRITE ,__emc_dapr_bits);
	__IO_REG32_BIT(EMCDYNAMICDAL,        0x2009C040,__READ_WRITE ,__emc_ddal_bits);
	__IO_REG32_BIT(EMCDYNAMICWR,         0x2009C044,__READ_WRITE ,__emc_dwr_bits);
	__IO_REG32_BIT(EMCDYNAMICRC,         0x2009C048,__READ_WRITE ,__emc_drc_bits);
	__IO_REG32_BIT(EMCDYNAMICRFC,        0x2009C04C,__READ_WRITE ,__emc_drfc_bits);
	__IO_REG32_BIT(EMCDYNAMICXSR,        0x2009C050,__READ_WRITE ,__emc_dxsr_bits);
	__IO_REG32_BIT(EMCDYNAMICRRD,        0x2009C054,__READ_WRITE ,__emc_drrd_bits);
	__IO_REG32_BIT(EMCDYNAMICMRD,        0x2009C058,__READ_WRITE ,__emc_dmrd_bits);
	__IO_REG32_BIT(EMCSTATICEXTENDEDWAIT, 0x2009C080,__READ_WRITE ,__emc_s_ext_wait_bits);
	__IO_REG32_BIT(EMCDYNAMICCFG0,     0x2009C100,__READ_WRITE ,__emc_d_config_bits);
	__IO_REG32_BIT(EMCDYNAMICRASCAS0,     0x2009C104,__READ_WRITE ,__emc_d_ras_cas_bits);
	__IO_REG32_BIT(EMCDYNAMICCFG1,     0x2009C120,__READ_WRITE ,__emc_d_config_bits);
	__IO_REG32_BIT(EMCDYNAMICRASCAS1,     0x2009C124,__READ_WRITE ,__emc_d_ras_cas_bits);
	__IO_REG32_BIT(EMCDYNAMICCFG2,     0x2009C140,__READ_WRITE ,__emc_d_config_bits);
	__IO_REG32_BIT(EMCDYNAMICRASCAS2,     0x2009C144,__READ_WRITE ,__emc_d_ras_cas_bits);
	__IO_REG32_BIT(EMCDYNAMICCFG3,     0x2009C160,__READ_WRITE ,__emc_d_config_bits);
	__IO_REG32_BIT(EMCDYNAMICRASCAS3,     0x2009C164,__READ_WRITE ,__emc_d_ras_cas_bits);
	__IO_REG32_BIT(EMCSTATICCNFG0,      0x2009C200,__READ_WRITE ,__emc_s_config_bits);
	...
	__IO_REG32_BIT(EMCSTATICWAITPG0,    0x2009C210,__READ_WRITE ,__emc_s_wait_pg_bits);
	...
	__IO_REG32_BIT(EMCSTATICCNFG1,      0x2009C220,__READ_WRITE ,__emc_s_config_bits);
	...
	__IO_REG32_BIT(EMCSTATICWAITPG1,    0x2009C230,__READ_WRITE ,__emc_s_wait_pg_bits);
	...
	__IO_REG32_BIT(EMCSTATICCNFG2,      0x2009C240,__READ_WRITE ,__emc_s_config_bits);
	...
	__IO_REG32_BIT(EMCSTATICWAITPG2,    0x2009C250,__READ_WRITE ,__emc_s_wait_pg_bits);
	...
	__IO_REG32_BIT(EMCSTATICCNFG3,      0x2009C260,__READ_WRITE ,__emc_s_config_bits);
	...
	__IO_REG32_BIT(EMCSTATICWAITPG3,    0x2009C270,__READ_WRITE ,__emc_s_wait_pg_bits);
	...
	__IO_REG32_BIT(CRC_SUM,               0x20090008,__READ_WRITE ,__crc_sum_bits);
	#define CRC_WR_DATA_DWORD  CRC_SUM_bit.__wr_dword.DATA
	#define CRC_WR_DATA_WORD   CRC_SUM_bit.__wr_word.DATA
	#define CRC_WR_DATA_BYTE   CRC_SUM_bit.__wr_byte.DATA
