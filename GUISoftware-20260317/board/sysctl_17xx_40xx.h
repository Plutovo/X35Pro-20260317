...
#if defined(CHIP_LPC177X_8X) || defined(CHIP_LPC40XX)   /*!< user manual corrected: 3->4 */
	FLASHTIM_120MHZ_CPU = 4,	/*!< Flash accesses use 5 CPU clocks. Use for up to 120 MHz CPU clock with power boot on*/
#else
