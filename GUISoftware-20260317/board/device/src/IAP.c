 ...
 */
	...
	*********************************************************************************************************/
	...
	/*********************************************************************************************************
	** Function name:       ReadDeviceSerial
	** Descriptions:        读取芯片序列号 58
	** output parameters:   paramout:    4个字节序列号
	** Returned value:      paramout:    4个字节序列号
	*********************************************************************************************************/
	INT32U  ReadDeviceSerial (void)
	{  
			paramin[0] = IAP_READSERIAL;                                           /* 设置命令字                   */
			(*IAP_Entry)(paramin, paramout);                                    /* 调用IAP服务程序              */
			return ((paramout[0]<<24)|(paramout[1]<<16)|(paramout[2]<<8)|(paramout[3]));                                               /* 返回状态码                   */
	}
